...
<tr><td>创建小组是否需要审核 :</td><td><input <?php if($strOption['isaudit']=='1') { ?>checked="select"<?php } ?> name="isaudit" type="radio" value="1" />审核 <input <?php if($strOption['isaudit']=='0') { ?>checked="select"<?php } ?> name="isaudit" type="radio" value="0" />不审核</td></tr>

<tr><td>每个会员加入小组数 :</td><td><input type="text" name="joinnum" value="<?php echo $strOption['joinnum'];?>" width="50" /> (创建和加入的总和)</td></tr>
