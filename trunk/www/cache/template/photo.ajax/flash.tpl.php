...
$(document).ready(function()
{
	...
	$("#uploadify").uploadify({
		...
		'scriptData':{'app':'photo','ac':'do','ts':'flash','userid':'<?php echo $TS_USER['user'][userid];?>','albumid':'<?php echo $albumid;?>'},
		'method':'GET', 
		...
		'onAllComplete' : function(event,data) {
			window.location = "<?php echo SITE_URL;?>index.php?app=photo&ac=ajax&ts=info&albumid=<?php echo $albumid;?>&addtime=<?php echo $addtime;?>";
		}
...
<div id="fileQueue"></div>
    ...
    <p>
	  ...
	  | <a href="<?php echo SITE_URL;?>index.php?app=photo&ac=ajax&ts=album">返回我的相册</a>
    </p>
