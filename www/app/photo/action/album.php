...
switch($ts){
	...
	case "":
		...
		$url = SITE_URL.tsUrl('photo','album',array('page'=>''));

		$lstart = $page*28-28;

		$arrAlbum = $new['photo']->findAll('photo_album',null,'albumid desc',null,$lstart.',28');
	...
	case "del":
		...
		header("Location: ".SITE_URL.tsUrl('photo','album',array('ts'=>'user','userid'=>$userid)));
