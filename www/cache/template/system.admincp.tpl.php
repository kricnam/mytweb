...
.header .menu{float:left;overflow:hidden;padding-right:20px;margin-top:25px;}
.header .menu ul{margin:0;padding:0;overflow:hidden;}
.header .menu ul li{list-style:none;float:left;padding:5px;color:#FFFFFF;font-size:12px;text-align:center;padding:10px 20px;font-weight: bold;}
.header .menu ul li a{color:#FFFFFF;}
.header .menu ul .select{background:#FFFFFF;}
.header .menu ul .select a{color:#555555;}

.header .right{float:right;color:#FFFFFF;margin:20px 20px 0 0;}
...
<body>
<div class="header">
<div class="logo" style='padding-left:350px;'><a href="index.php?app=system"><img src="app/<?php echo $app;?>/skins/<?php echo $skin;?>/logo.gif" alt="社区管理" /></a></div>
<div class="menu">
<ul>
...
<li><a href="index.php?app=system&ac=apps&ts=list"  target="main">组件管理</a></li>
