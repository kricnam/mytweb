...
<ul>
<li class="clearfix" id="event_home"><a href="<?php echo SITE_URL;?><?php echo tsurl('study')?>"><span>活动首页</span></a></li>

<div class="line"></div>

<li class="clearfix <?php if($typeid==0) { ?>on<?php } ?>"><a href="<?php echo SITE_URL;?><?php echo tsurl('study','type',array(typeid=>0))?>"><span>所有类型(<?php echo $arrStudyType['count'];?>)</span></a></li>
<?php foreach((array)$arrStudyType['list'] as $key=>$item) {?>
<li class="clearfix <?php if($typeid==$item['typeid']) { ?>on<?php } ?>"><a href="<?php echo SITE_URL;?><?php echo tsurl('study','type',array(typeid=>$item['typeid']))?>"><span><?php echo $item['typename'];?>(<?php echo $item['count_study'];?>)</span></a></li>
<?php }?>
</ul>
...
</div><h2><a href="<?php echo SITE_URL;?><?php echo tsurl('study','show',array('studyid'=>$item['studyid']))?>"><?php echo $item['title'];?></a> <span class="pl2">[<?php echo $item['type'][typename];?>]</span></h2>
<div class="pl intro">
